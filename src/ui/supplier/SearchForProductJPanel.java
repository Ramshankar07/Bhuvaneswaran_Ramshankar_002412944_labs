...
//    supplier;
    ...
    SearchForProductJPanel(JPanel workArea,Supplier product ) {
        initComponents();
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        int s= Integer.parseInt(idField.getText());
        Product result= product.getProductCatalog().searchProduct(s);
            if (result == null){
               JOptionPane.showMessageDialog(null,"Enter text", "Information", JOptionPane.INFORMATION_MESSAGE);            

            }   
            else{
//            productCatalog r = productCatalog.searchSupplier(result);
            ViewProductDetailJPanel pan= new ViewProductDetailJPanel(workArea,result );
            workArea.add("ViewProductDetailJPanel",pan);
